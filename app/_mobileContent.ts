...
export const IMG = {
  ...
  // Order matches the desktop L→R testimonial layout (Khun Sai, Khun Prae,
...
export const CONTENT: Record<Lang, any> = {
  en: {
    ...
    testimonials: [
      ...
      { name: 'Khun Prae', role: 'Business owner & Investor', quote: '“I want to thank you, Coach Aor, and thank myself for choosing to shift my inner energy. I spent so long chasing success until my body and mind broke down. Now I’ve found the courage to quit and build a new life for myself.”' },
